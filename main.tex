...
\title{Can we date an artists work from catalogue photographs?} % Poster title

\author{Alexander D Brown, Hannah M Dee, Gareth L Roderick and Lorna M Huges} % Author(s)

\institute{Aberystwyth University} % Institution(s)
